...
const FASES = [
  ...
  { fase: 2, titulo: 'Motor de Agendamento',    status: 'next',    desc: 'Janelas, disponibilidade' },
  { fase: 3, titulo: 'Módulo Documental',       status: 'pending', desc: 'XML, NF-e, validações' },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Bem-vindo, {usuario?.nome}. Fase 1 concluída.</p>
      </div>
